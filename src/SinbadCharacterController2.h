...
#define CHAR_HEIGHT 0.125
//#define CHAR_HEIGHT 2 //0.5*2.72          // height of character's center of mass above ground
...
class ChickenCharacterController
{
private:
...
public:
    ...
    ChickenCharacterController(Camera* cam) :
...
private:
    ...
    void setupBody(SceneManager* sceneMgr)
    {
        ...
        mBodyEnt = sceneMgr->createEntity("SinbadBody", "AnimeGirl.mesh");
        //mBodyEnt = sceneMgr->createEntity("SinbadBody", "Hen.mesh");
    ...
    void setupAnimations()
    {
        ...
        //{"Idle.Look.R", "Idle.Look.L.001", "Pick", "Jump", "Walk"};
    ...
    void updateCamera(Real deltaTime)
    {
        ...
        Vector3 goalOffset = (mCameraPivot->getPosition() + Vector3::UNIT_Z * 3.2) - mCameraNode->getPosition();
